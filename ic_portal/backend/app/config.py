...
class Config:
    ...
    # Match Six Peak IC / Investment Committee meetings only — NOT generic
    # "IC" mentions in unrelated meeting titles.
    ...
    followup_subject_prefix: str = "IC Follow-up"
    followup_portal_name: str = "Six Peak IC Weekly"
    followup_portal_url: str = "https://ic.sixpeakapps.com"

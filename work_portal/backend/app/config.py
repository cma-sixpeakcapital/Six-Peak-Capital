...
class Config:
    ...
    def from_env(cls) -> "Config":
        ...
        return cls(
            ...
            followup_subject_prefix=os.environ.get("FOLLOWUP_SUBJECT_PREFIX", "L10 Follow-up"),
            followup_portal_name=os.environ.get("FOLLOWUP_PORTAL_NAME", "L10 Weekly"),
            followup_portal_url=os.environ.get("FOLLOWUP_PORTAL_URL", "https://l10.sixpeakapps.com"),

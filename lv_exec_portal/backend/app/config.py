...
class Config:
    ...
    def from_env(cls, prefix: str = "") -> "Config":
        ...
        # PREFIXED vars (e.g. LVEXEC_PORTAL_API_KEY) and falls back to the bare
        ...
        return cls(
            ...
            followup_subject_prefix=env("FOLLOWUP_SUBJECT_PREFIX", "LV Exec Follow-up"),
            followup_portal_name=env("FOLLOWUP_PORTAL_NAME", "LV Executive"),
            followup_portal_url=env("FOLLOWUP_PORTAL_URL", "https://lvexec.sixpeakapps.com"),
            followup_cadence=env("FOLLOWUP_CADENCE", "biweekly"),
            ...
            followup_reminder_min_age_days=int(
                env("FOLLOWUP_REMINDER_MIN_AGE_DAYS", "7")
            ),
            followup_reminder_max_age_days=int(
                env("FOLLOWUP_REMINDER_MAX_AGE_DAYS", "14")
            ),
